...
import { products } from '@/lib/constants/mockData';
      ...
      <CardContent>
        <div className="grid gap-4">
          {products.map((product) => (
            <div key={product.id} className="grid grid-cols-1 md:grid-cols-12 gap-4 items-center p-2 rounded-lg hover:bg-muted/50 transition-colors">
